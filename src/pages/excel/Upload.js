    ...
    return (
      <>
        <div style={{display:'flex', justifyContent:'center', padding:'10px'}}>
          <a href='./dados.xlsx' download="dados.xlsx">
          <button className="botao" style={{ padding: '10px', color: 'white', backgroundColor: '#0078d4', border: 'none', borderRadius: '5px', margin: '10px' }}>
            Download Exemplo
          </button>
        </a>
        </div>
